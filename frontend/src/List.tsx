...
import { SpotifyPlaylistsAtom } from "./Spotify/SpotifyAtoms";
    ...
    <div className="px-3 py-2 overflow-hidden flex flex-col grow gap-2 border border-neutral-700">
      <div className="overflow-y-auto grow">
        {playlists?.map((playlist) => (
          ...
          >
            <div className="w-[3ch] h-[1lh] flex items-center justify-center shrink-0">
              <HeartIcon
                size={13}
                className={`${playlist.favorited ? "text-green-500" : ""}`}
                fill={playlist.favorited ? "currentColor" : "none"}
              />
            </div>
